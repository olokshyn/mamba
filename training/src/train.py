...
# logging.getLogger("lightning_fabric").setLevel(logging.DEBUG)
        ...
        try:
            ...
            if checkpoint_path.is_dir():
                ...
                if (not last_ckpt.exists()) or (
                    autosave_ckpt.exists() and last_modification_time(autosave_ckpt) > last_modification_time(last_ckpt)
                ):
